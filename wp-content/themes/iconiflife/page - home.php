            ...
            if( $query->have_posts()) { ?>
                <?php while( $query->have_posts() ) {
                    ...
                    <div class="feature-story jpibfi_container">
                        <?php if(get_field('no_click_through')) {
                            the_post_thumbnail('home-feature2x'); ?>
                    ...
                    <?php if( get_row_layout() == 'video_block' ) {?>
                        <div class="video-block">
                            <?php
                                ...
                                $articleImg = get_sub_field('article_image');
                            ?>
                            <h5 class="featured-video"><?php the_sub_field('section_title');?></h5>
                            <h5 class="featured-subtitle"><?php the_sub_field('section_subtitle');?></h5>
