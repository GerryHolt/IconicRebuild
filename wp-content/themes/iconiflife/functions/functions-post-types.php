...
$postName         = 'Specials'; // Name of post type
$postNameSlug     = 'special'; // Name of post type
$postNameSingular = 'Special Post'; // Singular Name
$postNamePlural   = 'Special Posts'; // Plural Name
...
$taxonomyName         = 'Special Categories';
$taxonomyNameSlug     = 'special-categories';
$taxonomyNameSingular = 'Special Category';
$taxonomyNamePlural   = 'Special Categories';
register_taxonomy(
	$taxonomyNameSlug, array( $postNameSlug ), array(
		'hierarchical' => true, // Category or Tag functionality
		'query_var' => true,
...
$postNameSlug     = 'videos'; // Name of post type
$postNameSingular = 'Video Post'; // Singular Name
$postNamePlural   = 'Video Posts'; // Plural Name
$postDashIcon     = 'dashicons-video-alt3'; // Define Dashicon | Commonly Used: News = dashicons-welcome-widgets-menus, Clients - dashicons-businessman, Team - dashicons-groups, Event - dashicons-calendar, Full List - https://developer.wordpress.org/resource/dashicons/
...
$taxonomyName         = 'Video Categories';
$taxonomyNameSlug     = 'video-categories';
$taxonomyNameSingular = 'Video Category';
$taxonomyNamePlural   = 'Video Categories';
register_taxonomy(
	$taxonomyNameSlug, array( $postNameSlug ), array(
		'hierarchical' => true, // Category or Tag functionality
		'query_var' => true,
